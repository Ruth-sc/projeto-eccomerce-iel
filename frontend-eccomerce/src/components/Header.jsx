...
const Header = () => {
  ...
  return (
    <header style={{ display: 'flex', flexDirection: 'column', padding: '20px 40px', borderBottom: '1px solid #ccc' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
        ...
        <div className="search-container" style={{ display: 'flex', alignItems: 'center', flexGrow: 1, marginLeft: '20px', marginRight: '20px', position: 'relative' }}>
          <input
            ...
            style={{ padding: '8px 32px 8px 8px', flex: 1, borderRadius: '4px', border: '1px solid #ccc', color: '#474747' }}
          />
          <i
